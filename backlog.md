...
| ~~PAGOS~~ | ~~Comprobante de Yape reutilizable — sin detección de duplicados~~ | ✅ **Hecho 2026-08-19**, pendiente de deploy. Pregunta de la señora el día 4. Avisa al owner, no bloquea al comensal. **Ojo:** solo atrapa el archivo idéntico, no una recaptura — ver `ISS-051` |
...
| **ISS-049** | **El pedido se pierde si la pestaña se recarga sola al salir a pagar** — `menu.html` no persistía nada del pedido en curso; en un celular de gama media Chrome puede descargar la pestaña de fondo mientras el comensal paga en Yape/Plin | 🔴 Prioridad alta a pedido explícito del usuario. Reportado por la dueña, Día 5 del piloto: *"si se les reinicia cada vez que pagan van a aburrirse de usar la app"*. **Hecho 2026-08-19** — el usuario dijo que lo desplegaba ahora mismo, sin confirmación explícita todavía — ver `ISS-049` |
| **ISS-050** | **El número de pedido que ve el comensal no coincide con el de la dueña** — el comensal veía el id crudo (sigue de corrido, puede ser #96 con 22 pedidos hoy); la dueña ya veía `numero_dia` (1, 2, 3…) | 🔴 Reportado por una clienta ("mi orden me sale 96"), Día 5. **Hecho 2026-08-19**, pendiente de deploy — ver `ISS-050` |
