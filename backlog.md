...
| **ISS-049** | **El pedido se pierde si la pestaña se recarga sola al salir a pagar** — `menu.html` no persistía nada del pedido en curso; en un celular de gama media Chrome puede descargar la pestaña de fondo mientras el comensal paga en Yape/Plin | 🔴 Prioridad alta a pedido explícito del usuario. Reportado por la dueña, Día 5 del piloto: *"si se les reinicia cada vez que pagan van a aburrirse de usar la app"*. **Hecho 2026-08-19**, pendiente de deploy — ver `ISS-049` |
