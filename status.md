...
**Desplegado el 2026-09-21** (`21859ce..4c27845`, ver la tabla de arriba). Servidor y repo en el mismo commit.
**Sigue pendiente:** reinicio del servidor (`System restart required`) de madrugada tras un backup manual; menú del día en el Restaurante Demo (`id=1`); aviso automático de caída (UptimeRobot → `/health`); restore de prueba del backup; copia externa de backups.
